...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](jayesh-jd/JACKZBOT)**",
        ...
        "__INFO:jå¢kzßð†:Logged in as 557667062__",
        "__INFO:jå¢kzßð†:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
async def _(event):
    ...
    event = await edit_or_reply(event, "cyclet")
    animation_chars = [
        "⬛⬛⬛\n⬛⬛⬛\n⬛⬛⬛",
        "⬛⬛⬛\n⬛🔄⬛\n⬛⬛⬛",
        "⬛⬆️⬛\n⬛🔄⬛\n⬛⬛⬛",
...
async def _(event):
    if event.fwd_from:
        return
    event = await edit_or_reply(event, "plane will fly juuuuuu.....")
    await event.edit("✈-------------")
    await event.edit("-✈------------")
    await event.edit("--✈-----------")
    await event.edit("---✈----------")
...
async def _(event):
    ...
    animation_ttl = range(12)
    event = await edit_or_reply(event, "Police tuldultuldultuldul")
    animation_chars = [
        "🔴🔴🔴⬜⬜⬜🔵🔵🔵\n🔴🔴🔴⬜⬜⬜🔵🔵🔵\n🔴🔴🔴⬜⬜⬜🔵🔵🔵",
        "🔵🔵🔵⬜⬜⬜🔴🔴🔴\n🔵🔵🔵⬜⬜⬜🔴🔴🔴\n🔵🔵🔵⬜⬜⬜🔴🔴🔴",
        "🔴🔴🔴⬜⬜⬜🔵🔵🔵\n🔴🔴🔴⬜⬜⬜🔵🔵🔵\n🔴🔴🔴⬜⬜⬜🔵🔵🔵",
