...
async def _(event):
    ...
    animation_chars = [
        ...
        "👁👁\n  👄  =====> Bhag lode",
        "👀\n .....mere userbot me gaali se related koi chez nahi hai...."
        " 👀\n bhosdike,maderchod,bahan ke lode,macchar ki jaaht,gandu,maa ki chut teri,tatto ke sudaagar...."
    ]
